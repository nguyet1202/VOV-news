...
<?php esc_html_e( 'Skip to content', 'news-jack' ); ?></a>
    <div class="wrapper">
        <header class="mg-headwidget center light">
            ...
            $newsup_header_overlay_color = get_theme_mod('newsup_header_overlay_color','#fff');?> style="background-color:<?php echo esc_attr($newsup_header_overlay_color);?>;" <?php } ?>> 
                <?php do_action('newsjack_action_header_section'); ?>
              </div>
              </div>
          </div>
        ...
        <div class="container-fluid ">
          <!-- Right nav -->
                    <div class="m-header align-items-center">
                        ...
                        <!-- navbar-toggle -->
                        <button class="navbar-toggler mx-auto" type="button" data-toggle="collapse" data-target="#navbar-wp" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="<?php esc_attr_e('Toggle navigation','news-jack'); ?>">
...
<div class="clearfix"></div>
<?php do_action('newsjack_action_front_page_top_post');
if (is_front_page() || is_home()) { ?>
 ...
 do_action('newsjack_action_front_page_main_section_1');
}
?>
 <div>